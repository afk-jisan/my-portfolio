      ...
      <div className="min-h-[calc(100vh-69px)] mx-auto px-6 py-12 md:py-16 lg:py-10 ">
        <div className="xl:w-[1280px] mx-auto text-center ">
          <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center ">
            <div className="px-10">
              <p className="text-[var(--color-text)] mb-8 text-lg text-[24px] text-start">I'm <span className="font-semibold text-blue-600">Baktier Galib Jisan,</span><br/> a passionate front-end developer and CSE student at BRAC University. I love building clean, user-focused web interfaces with modern technologies.</p>
              <Socials />
            </div>
          ...
          <div className="text-left space-y-6 mx-10">
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-2">👨‍💻 What I Do</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-2">🚀 Goals</h2>
              <p className="text-[var(--color-text)]">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-2">📚 Education</h2>
              <p className="text-[var(--color-text)]">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-2">🛠 Skills</h2>
