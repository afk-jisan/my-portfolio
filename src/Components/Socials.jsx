    ...
    return(
        <IconContext.Provider value={{ className: "global-class-name", size: "2em"  }}>
            <div className="flex flex-row gap-2 justify-center cursor-pointer ">
                ...
                <a href="YOUR_GITHUB_PROFILE_LINK" target="_blank" rel="noopener noreferrer" ><FaLinkedin className="hover:text-blue-500 text-[#69070a] dark:text-[#44545c] dark:hover:text-[#9da7bb]"/></a>
